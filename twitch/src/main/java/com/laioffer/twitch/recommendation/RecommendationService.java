...
public class RecommendationService {
    ...
    private static final int PER_GAME_ITEM_SIZE = 20;
    ...
    public TypeGroupedItemList recommendItems(UserEntity userEntity) {
        ...
        int perGameListSize = PER_GAME_ITEM_SIZE / gameSize;
    ...
    private List<ItemEntity> recommendStreams(List<String> gameIds, Set<String> exclusions) {
        List<Stream> streams = twitchService.getStreams(gameIds, PER_GAME_ITEM_SIZE);
